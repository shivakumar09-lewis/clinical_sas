...
run;/* ── Listing L14.3.1 — Subject AE Listing ── */
ods rtf file='/home/sasuser.v94/output/L14_3_1_AE_Listing.rtf' style=journal;
title1 "Listing 14.3.1";
title2 "Adverse Events by Subject — Safety Analysis Set";
footnote1 "AEs sorted by Subject, System Organ Class, Start Date";

proc report data=work.adae headline headskip;
  column USUBJID TRT01P AEBODSYS AEDECOD AESEV AETOXGR AESER AESTDTC AEENDTC AEOUT;
  define USUBJID  / order 'Subject ID' width=22;
  define TRT01P   / order 'Treatment' width=10;
  define AEBODSYS / order 'System Organ Class' width=30;
  define AEDECOD  / display 'Preferred Term' width=30;
  define AESEV    / display 'Severity' width=10;
  define AETOXGR  / display 'Grade' width=6;
